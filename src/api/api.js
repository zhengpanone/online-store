...
export const register = params => { return axios.post(`${userUrl}/u/v1/user/register`, params) }

//短信
export const getMessage = params => { return axios.post(`${userUrl}/u/v1/base/send_sms`, params) }
